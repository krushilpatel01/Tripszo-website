...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete_trip'])) {
        ...
        if (isset($_POST['trip_id']) && !empty($_POST['trip_id'])) {
            ...
            if ($stmt->execute()) {
                echo "<script>alert('Trip successfully Delete!'); window.location.href='destination.php';</script>";
            } else {
    ...
    if (isset($_POST['update_trip'])) {
        ...
        header("Location: trip-update/update-destination.php?trip_id=$trip_id");
        exit();
    }
}
?>
...
<head>
    ...
    <title>AdminLTE 3 | Trip-Destination</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row add-destination">
                        <div class="col-4 mb-5">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <label for="daysNights">Destination Name :</label>
                                <input type="text" name="name" id="" placeholder="Enter Destination Name" required
                                    style="width:100%; margin:10px auto; padding:10px 0px; text-indent:10px; outline: none;">
                                <label for="daysNights">Destination Details :</label>
                                <input type="text" name="detail" id="" placeholder="Destination Details" required
                                    style="width:100%; margin:10px auto; padding:10px 0px; text-indent:10px; outline: none;">
                    ...
                    <div class="row d-block flex-wrap show-destination">
                        <div class="col d-flex flex-wrap" style="width: 100%;">
                            <?php
                            $select_trip = mysqli_query($conn, "SELECT * FROM `destination`") or die('query failed');

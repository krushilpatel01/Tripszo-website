...
<body>
    ...
    <section class="trip-section-wrapper">
        <div class="container">
            <h2 class="centerd-title" style="font-size: 46px; color:black">ALL LATEST <br> <span
                    style="color:blue">WEEKEND</span> TRIPS</h2>
            <div class="row trips-wrapper">
                <div class="col-sm-12 col-md-6 col-lg-6 trip-card">
                    <div class="trip-toltip">1 Night 2 Days</div>
